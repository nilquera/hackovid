      ...
      <div>
        ...
        <p>
          <i>
            ...
            venedores dels nostres barris han vist com disminuien les seves
            ventes de forma preocupant.
          </i>
        </p>
        <p>
          <b>Comencia</b> és una plataforma molt senzilla destinada a facilitar
          el comerç de les botigues de barri.
        </p>
        <p>
          El venedor crea un <b>anunci</b> per la seva botiga i afegeix una
          sèrie de <b>lots de productes</b> disponibles.
        </p>
        <p>
          Mitjançant un <b>mapa interactiu</b>, els veins i veines de la zona
          poden trobar els anuncis dels comerços més propers que necessiten
          ajuda.
        </p>
        ...
        <ol>
          ...
          <p>
            Et demanarem que introdueixis els lots de productes que ofereix el
            teu comerç
          </p>
        </ol>
